...
var Task = function () {
    ...
    var Task = _classThis = /** @class */ (function (_super) {
        ...
        function Task_1() {
            ...
            _this.completed = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _completed_initializers, void 0));
            _this.groupId = (__runInitializers(_this, _completed_extraInitializers), __runInitializers(_this, _groupId_initializers, void 0));
            __runInitializers(_this, _groupId_extraInitializers);
            return _this;
        }
        return Task_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _name_decorators = [(0, mongoose_1.Prop)({ required: true, maxlength: 64 })];
        _description_decorators = [(0, mongoose_1.Prop)({ maxlength: 256 })];
        _completed_decorators = [(0, mongoose_1.Prop)({ default: false })];
        _groupId_decorators = [(0, mongoose_1.Prop)()];
